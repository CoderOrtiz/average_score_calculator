function scoreCalculator() {
    ...
    alert(`The average rounded score will be calculated but both teams need to at least reach a minimal rounded score of 100. For there to be a draw, both teams must get at least a rounded score of 100 or more.`)
